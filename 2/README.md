...
n the way to your gravity assist around the Moon, your ship computer beeps angrily about a `"1202 program alarm"`. On the radio, an Elf is already explaining how to handle the situation: _"Don't worry, that's perfectly norma--"_ The ship computer bursts into flames.
...
_Solution: noun=`82`, verb=`98` -> `8298`._
